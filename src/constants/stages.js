...
// TODO Complete other kits

export const FortaDeFiKit = {
  key: 'defi-kit',
  name: 'Forta DeFi Kit',
  botIds: [],
  stages: [
    ...
    },
    {
      label: 'Preparation',
      color: STAGE_COLOR.orange,
      alertIds: ['PREPARATION-0']
    },
    {
      label: 'Exploitation',
      color: STAGE_COLOR.red,
      alertIds: ['EXPLOITATION-0']
    }
  ]
};

export const FortaGovernanceKit = {
  key: 'governance-kit',
  name: 'Forta Governance Kit',
  botIds: [],
  stages: [
    {
      label: 'Funding',
